...
1. USAGE:
	The avr-evtd daemon is aimed at the Buffalo series of Linkstation
	and Kurobox.  This replaces the existing ppc_uartd daemon.
	The daemon configures the AVR and provides the necessary
	'keep-alives' to the AVR watchdog timer.
	The daemon also checks that the /mnt and / filesystems are
	within scope (disk space remaining) and also monitors the
